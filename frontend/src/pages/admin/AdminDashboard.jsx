      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { label: 'Assistant Actions', value: usageStats?.assistantActions || 0, icon: TrendingUp },
              { label: 'Chatbot Messages', value: usageStats?.chatbotMessages || 0, icon: BarChart3 },
              { label: 'Content Generated', value: usageStats?.contentGenerations || 0, icon: Calendar },
              { label: 'Insights Refreshes', value: usageStats?.insightsRefreshes || 0, icon: Globe }
            ].map((item) => (
